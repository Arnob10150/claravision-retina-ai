...
import { ArrowLeft, EyeOff, Loader as Loader2, Brain, Shield, Activity, ChevronRight } from 'lucide-react'
    ...
    <div className="min-h-screen flex bg-background overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center w-full lg:w-[480px] px-6 py-10 bg-background relative overflow-y-auto">
        ...
        <div className="w-full max-w-sm relative z-10 py-4">
          <Link to="/" className="inline-flex items-center gap-1.5 text-xs font-medium text-muted-foreground hover:text-primary transition-colors mb-5">
